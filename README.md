...
`Java` was the primary language utilized throughout the project, with additional knowledge of `Spring MVC` and  `Ajax`.

Overall, this project serves as an excellent example of how to build a robust RESTful API using modern software development practices, and demonstrates a strong understanding of the underlying principles that govern API design and implementation.
